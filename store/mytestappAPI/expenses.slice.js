...
export const api_v1_expenses_list = createAsyncThunk("expenses/api_v1_expenses_list", async payload => {
  const response = await apiService.api_v1_expenses_list(payload);
  return response.data;
});
export const api_v1_expenses_create = createAsyncThunk("expenses/api_v1_expenses_create", async payload => {
  const response = await apiService.api_v1_expenses_create(payload);
  return response.data;
});
export const api_v1_expenses_retrieve = createAsyncThunk("expenses/api_v1_expenses_retrieve", async payload => {
  const response = await apiService.api_v1_expenses_retrieve(payload);
  return response.data;
});
export const api_v1_expenses_update = createAsyncThunk("expenses/api_v1_expenses_update", async payload => {
  const response = await apiService.api_v1_expenses_update(payload);
  return response.data;
});
export const api_v1_expenses_partial_update = createAsyncThunk("expenses/api_v1_expenses_partial_update", async payload => {
  const response = await apiService.api_v1_expenses_partial_update(payload);
  return response.data;
});
export const api_v1_expenses_destroy = createAsyncThunk("expenses/api_v1_expenses_destroy", async payload => {
...
const expensesSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(api_v1_expenses_list.pending, (state, action) => {
